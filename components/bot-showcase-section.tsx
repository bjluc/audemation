...
export default function AirbnbBotShowcase() {
  return (
    <section id="airbnb-bot" className="py-16 md:py-24 relative" aria-labelledby="airbnb-bot-heading">
      ...
      <div className="container mx-auto px-4 relative">
        <div className="text-center mb-16 md:mb-24">
          ...
          <h2 id="airbnb-bot-heading" className="text-2xl md:text-3xl lg:text-4xl font-bold text-gradient mb-6 leading-relaxed py-2">
